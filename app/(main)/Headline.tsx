...
function Developer() {
  return (
    <span className="group">
      <span className="font-mono">&lt;</span>效率控
  ...
  return (
    <div className="max-w-2xl">
      ...
      >
        <Balancer>
          欢迎您的访问，
          <PeekabooLink href="https://www.huizha.com">绘札</PeekabooLink>
          是我的精神角落，我会在这里倾注热情、分享兴趣和记录灵感。
      ...
      >
        <SocialLink
          href="https://huizha.com/twitter"
          aria-label="我的推特"
          platform="twitter"
        />
        <SocialLink
          href="https://huizha.com/youtube"
          aria-label="我的 YouTube"
          platform="youtube"
        />
        <SocialLink
          href="https://huizha.com/bilibili"
          aria-label="我的 Bilibili"
          platform="bilibili"
        />
        <SocialLink
          href="https://huizha.com/github"
          aria-label="我的 GitHub"
          platform="github"
        />
        <SocialLink
          href="https://huizha.com/tg"
          aria-label="我的 Telegram"
          platform="telegram"
        />
        <SocialLink href="/feed.xml" platform="rss" aria-label="RSS 订阅" />
        <SocialLink
          href="mailto:hi@huizha.com"
          aria-label="我的邮箱"
          platform="mail"
        />
      </motion.div>
